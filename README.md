...
*   **Data Scraping:** Extracted over 10,000 comments and metadata from YouTube videos (2014-2023) across categories like GenZ's Opinions, TED Talks, Short Films, and Research.
*   **Data Gathering:** Collected all of the comments and metadata from multiple notebooks into a single notebook for the analysis [Link to the Main Notebook File](
